...
<title>論壇forum</title>
<link rel="stylesheet"
	href="<c:url value="/articleForum/css/bootstrap.min.css"/>" />
<link
	...
	<div class="card-group">
		<div class="card">
			...
			<div class="card-body">
				...
				<p>
					<small class="post_Time" style="font-size: small;">3月20日發布</small>
				</p>
			</div>
		</div>
		...
		<div class="card">
			...
			<div class="card-body">
				<h5>
					<a href="#" class="article_title"> <!-- 文章標題 --> 台新卡友來來來
					</a>
				</h5>
				<span class="article_content">文章內文</span>
				<p>
					<small class="post_Time" style="font-size: small;">3月25日發布</small>
				</p>
			</div>
		</div>
		<div class="card">
			...
			<div class="card-body">
				<h5>
					<a href="#" class="article_title"> <!-- 文章標題 --> 神卡分享
					</a>
				</h5>
				<span class="article_content">文章內文</span>
				<p>
					<small class="post_Time" style="font-size: small;">2月28日發布</small>
				</p>
			</div>
		</div>
	</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<!-- 內容 -->
							<form id="msform"
								action="<c:url value="/articleForum/listforum" />" method="post"
								enctype="multipart/form-data">
								<!-- 發文者頭像 -->
								<div class="container">
									<img
										src="${pageContext.request.contextPath}/init/getMemberImage?id=${LoginOK.m_id}"
										alt="profile-sample5" id="memberid_img" />
									<span style="font-size: 0.6em; color: #3e8bbe;">發文者</span><span
										id="article_m_id" style="font-size: 0.8em;">:${LoginOK.m_id}</span>
								</div>
								<hr />
								...
								<p class="text">
									<textarea name="text"
										...
										id="postArticle_content" placeholder="內文" style="height: 300px;"></textarea>
								</p>
								...
								<!-- 文章標籤選擇 標籤意思跟主題一樣-->
								<legend
									style="font-size: 13px; padding-bottom: 7px; padding-top: 15px;">
									標籤選擇 </legend>
								<div id="checkline">
		...
		<div class="row" style="display: flex;">
			...
			<div class="col-9" style="min-height:1100px;">
				...
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					<li class="nav-item"><a class="nav-link" id="collection-tab"
						data-toggle="tab" href="#collection" role="tab"
						aria-controls="collection" aria-selected="false">收藏</a>
					</li>
				</ul>
				...
				<div class="tab-content" id="myTabContent">
								...
								<div class="card my-2">
									<div class="row">
										...
										<div class="col-7 my-2">
												...
												<div class="row"
													...
													<div class="col-5 px-0"
														...
														<form style="margin: 0px; display: inline" method="post"
															action="<c:url value='/articleForum/track/${entry.article_Id}/${LoginOK.m_id}' />">
											...
											<div class="my-3">
												<a
													href='<c:url value='/articleForum/reponseActivity/${entry.article_Id}' />'
													id="">${entry.article_title}</a>
											</div>
											<!-- 文章內容的前幾個字 -->
											<div class="article_content my-3">
												<c:forEach varStatus="stVar2" var="entry2"
                        	 		...
                        	 		${entry2}
											...
											<!-- 總回文數 -->
											<div class="my-3"
												style="font-weight: initial; font-size: 14px; color: rgb(177, 172, 172);">
												回應 <span class="total_reply"> <c:forEach
														varStatus="stVar1" var="entry1" items="${responserCount}">
					...
					<div class="tab-pane fade" id="collection" role="tabpanel"
						...
						<!-- 下方論壇卡片 -->
						<div class="container">
							<c:forEach varStatus="stVar10" var="entry10"
								items="${trackBeans}">
								<!-- 卡片一 -->
								<div class="card my-2">
									<div class="row">
										...
										<div class="col-7 my-2">
											...
											<div class="my-3">
												<a
													href="<c:url value='/articleForum/reponseActivity/${entry10.article_Id}' />"
													id="">${entry10.article_title}</a>
											</div>
											<!-- 文章內容的前幾個字 -->
											<div class="article_content my-3">
												<c:forEach varStatus="stVar12" var="entry12"
													items="${trackArticle_content}">
                        	 		...
                        	 		${entry12}
											...
											<div class="my-3"
												style="font-weight: initial; font-size: 14px; color: rgb(177, 172, 172);">
												回應 <span class="total_reply"> <c:forEach
														varStatus="stVar11" var="entry11"
														items="${trackArticle_responserCount}">
					...
					<div class="modal fade" id="revise" tabindex="-1" role="dialog"
						aria-labelledby="reviseTitle" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<!-- 叉叉按鈕 -->
								...
								<div class="modal-body">
									<!-- 內容 -->
									<form id="msform"
										action="<c:url value="/articleForum/listforum" />"
										method="post" enctype="multipart/form-data">
										<!-- 發文者頭像 -->
										<div class="container">
											<img src="./images/id_photo/memberphoto_6.png"
												alt="profile-sample5" id="memberid_img" />
											<span style="font-size: 12px; color: #3e8bbe;">發文者</span><span
												id="article_m_id" style="font-size: 16px;">豬血糕不要香菜</span>
										</div>
										<hr />
										...
										<p class="text">
											<textarea name="text"
												class="validate[required,length[6,300]] feedback-input"
												id="article_content" placeholder="內文" style="height: 300px;"></textarea>
										</p>

										<!-- 上傳圖片的按鈕 -->
										<h1 class="fs-title">文章照片</h1>
										<div class="articleimage" style="padding-bottom: 5px;">
											<input id="input-b7" name="input-b7[]" type="file" multiple />
										</div>
