...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href='<c:url value="../css/member_register.css" />'
    />
  ...
  <body>
    ...
    <div class="et-hero-tabs">
      ...
      <div class="et-hero-tabs-container">
        ...
        <a class="et-hero-tab" href='<c:url value="/shopping/listProduct" />'
          >商城</a
        >
        <a class="et-hero-tab" href='<c:url value="/news/lastestNews"/>'
          >資訊網</a
        >
    ...
    <div class="floater toparea">
      您現在的身分為訪客,已有會員帳號了嗎?
      <a href="member_login" style="color: #ff5964; font-size: 25px;"
        >快來登入<i class="bx bx-happy-alt"></i>
      </a>
    </div>
    <!---------------------表單區塊-------------------------------->
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  id="signup_id"
                  value="${param.account}"
                  placeholder="由英文與數字組成"
                  autocomplete="off"
                  required="required"
                /><br />
                <font color="red" size="-1" id="accountError"
                  >${MsgMap.errorIdDup}</font
                >
              </td>
            </tr>
            <tr>
              ...
              <td>
                <input
                  ...
                  value=""
                  placeholder="密碼長度需8位數字以上"
                  autocomplete="off"
                  required="required"
                />
                <input type="checkbox" onclick="myFunction()" />顯示<br />
                <span style="font-size: 15px; color: maroon;"
                  >8碼以上的英文大小寫+數字特殊符號@#組成</span
                ><br />
                <font color="red" size="-1" id="passwordError"></font>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <input
                  ...
                  required="required"
                /><br />
                <font color="red" size="-1" id="nameError"></font>
              </td>
            </tr>
            <tr>
              <th><label class="required">電子郵件</label></th>
              <!-----電子郵件----->
              <td>
                <input
                  class="validate[required,custom[email]]"
                  ...
                  required="required"
                /><br />
                <font color="red" size="-1" id="emailError"></font>
              </td>
            </tr>
            <tr>
              <th><label class="required">性別</label></th>
              <!-----性別----->
              <td>
                <input
                  type="radio"
                ...
                <input
                  ...
                  value="female"
                />&nbsp;女<br />
                <font color="red" size="-1" id="genderError"></font>
              </td>
            </tr>
            <tr>
              <th><label class="required">手機</label></th>
              <!-----手機----->
              <td>
                <input
                  type="text"
                  name="phone_num"
                  placeholder=" 輸入10位數字"
                  value="${param.phone_num}"
                  style="width: 15rem;"
                  required="required"
                /><br />
                <font color="red" size="-1" id="phone_numError"></font>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <input
                  ...
                  required
                /><br />
                <font color="red" size="-1" id="birthdayError"></font>
              </td>
            </tr>
          </table>
        </form>
